/* =========================================================================
   ...
   app-wealth-os.js — render() dispatcher, renderTopbar, renderDisclaimerStrip
   and boot, same shape as js/app.js but boots from Supabase instead of
   calling render() directly. Loaded in place of app.js -- never load both,
   they both declare render()/renderTopbar()/renderDisclaimerStrip()/STAGES.
   ========================================================================= */
